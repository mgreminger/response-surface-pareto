...
<svelte:head>
  <script src="https://bossanova.uk/jexcel/v4/jexcel.js">
  </script>
  <script
    src="https://bossanova.uk/jsuites/v3/jsuites.js"
    on:load={initializeJexcel}>
  </script>
  <link
    rel="stylesheet"
  ...
  <link
    rel="stylesheet"
    href="https://bossanova.uk/jexcel/v4/jexcel.css"
    type="text/css" />
</svelte:head>
